...
public class PrevPost extends javax.swing.JFrame {
   ...
   private int userId;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrevPost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
